        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardTag = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    ...
                    CardVideoAutoplay = table.Column<bool>(type: "boolean", nullable: false),
                    Latitude = table.Column<double>(type: "double precision", nullable: true),
                    Longitude = table.Column<double>(type: "double precision", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsFeatured = table.Column<bool>(type: "boolean", nullable: false),
                    IsMarquee = table.Column<bool>(type: "boolean", nullable: false),
                    OrderIndex = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HeroSlides_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPlan = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Header telefon", "PhoneNumber", "+90 212 236 19 88" },
                    { 2, "E-posta", "Email", "info@brikonyapi.com" },
                    { 3, "Adres", "Address", "Seyrantepe Mahallesi İbrahim Karaoğlanoğlu Cad. No:147 K:7 KAĞITHANE-İSTANBUL" },
                    { 4, "Instagram URL", "Instagram", "" },
                    { 5, "Facebook URL", "Facebook", "" },
                    { 6, "LinkedIn URL", "LinkedIn", "" },
                    { 7, "Slogan", "CompanySlogan", "Geleceği İnşa Ediyoruz" },
                    { 8, "Hakkımızda metni", "AboutText", "Brikon Yapı olarak kaliteli ve güvenilir inşaat hizmetleri sunuyoruz." },
                    { 9, "WhatsApp numarası", "WhatsApp", "" },
                    ...
                    { 23, "Hakkımızda görsel/video yolu", "AboutMediaPath", "" }
                });
