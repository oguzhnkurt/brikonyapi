    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Header telefon numarası", "PhoneNumber", "+90 555 000 00 00" },
                    { 2, "İletişim e-posta", "Email", "info@brikonyapi.com" },
                    { 3, "Şirket adresi", "Address", "İstanbul, Türkiye" },
                    { 4, "Instagram profil URL", "Instagram", "" },
                    { 5, "Facebook profil URL", "Facebook", "" },
                    { 6, "LinkedIn profil URL", "LinkedIn", "" },
                    { 7, "Şirket sloganı", "CompanySlogan", "Geleceği İnşa Ediyoruz" },
                    { 8, "Hakkımızda kısa metin", "AboutText", "Brikon Yapı olarak, yılların verdiği tecrübe ile kaliteli ve güvenilir inşaat hizmetleri sunuyoruz." }
                });
